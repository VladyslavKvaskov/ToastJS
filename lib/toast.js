...
const showRipple = (e = '', rippleElement) => {
  ...
  const bgColorRipple = window.getComputedStyle(rippleElement, null).getPropertyValue('background-color');
  // if (bgColorRipple === 'rgba(0, 0, 0, 0)' || bgColorRipple.includes('rgba(255, 255, 255') || !window.getComputedStyle(rippleElement, null).getPropertyValue('background-color')) {
