...
class Ripple extends HTMLElement {
  ...
  showRipple(e = '') {
    let targetRipple = this;
    if (this.dataset.rippleTarget) {
      targetRipple = document.querySelector(this.dataset.rippleTarget);
    }

    const rippleEl = document.createElement('span');
    const rippleDiameter = Math.max(targetRipple.clientWidth, targetRipple.clientHeight);
    ...
    if (e?.isTrusted) {
      if (targetRipple.contains(this)) {
        ...
        rippleElBounds = this.getBoundingClientRect();
